...
>
> Development has moved to a new repository dedicated to the **Verdis Ecosystem**, where all future projects—including Verdis Browser, Verdis Search, Verdis AI, and other sustainability-focused software—will be developed.
>
> This repository will remain available as an archive to preserve previous work.
